...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionCalendarBackgroundColorTodayHighlight = LeaveCasaColors.BLUE_COLOR
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = LeaveCasaColors.BLUE_COLOR
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = LeaveCasaColors.BLUE_COLOR
    ...
    open var optionClockBackgroundColorAMPMHighlight = LeaveCasaColors.BLUE_COLOR
    ...
    open var optionClockBackgroundColorHourHighlight = LeaveCasaColors.BLUE_COLOR
    open var optionClockBackgroundColorHourHighlightNeedle = LeaveCasaColors.BLUE_COLOR
    ...
    open var optionClockBackgroundColorMinuteHighlight = LeaveCasaColors.BLUE_COLOR
    open var optionClockBackgroundColorMinuteHighlightNeedle = LeaveCasaColors.BLUE_COLOR
    ...
    open var optionButtonFontColorCancel = LeaveCasaColors.BLUE_COLOR
    open var optionButtonFontColorDone = LeaveCasaColors.BLUE_COLOR
    open var optionButtonFontColorCancelHighlight = LeaveCasaColors.BLUE_COLOR.withAlphaComponent(0.25)
    open var optionButtonFontColorDoneHighlight = LeaveCasaColors.BLUE_COLOR.withAlphaComponent(0.25)
    ...
    open var optionTopPanelBackgroundColor = LeaveCasaColors.BLUE_COLOR
    ...
    open var optionSelectorPanelBackgroundColor = LeaveCasaColors.BLUE_COLOR.withAlphaComponent(0.9)
    ...
    fileprivate var tintColor : UIColor! = LeaveCasaColors.BLUE_COLOR
...
internal class WWCalendarRow: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if detail.type == .month {
            ...
            let str = NSAttributedString(string: monthName, attributes: [NSAttributedString.Key.font: monthFont ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: monthFontColor ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph])
            ...
            for (index, element) in days.enumerated() {
                let str = NSAttributedString(string: element, attributes: [NSAttributedString.Key.font: dayFont ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: dayFontColor ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph])
                ...
                if date.weekday == i {
                    ...
                    if comparisonDates.contains(date) {
                        ...
                        if multipleSelectionEnabled {
                            var testStringSize = NSAttributedString(string: "00", attributes: [NSAttributedString.Key.font: dateTodayFontHighlight ?? UIFont.systemFontSize, NSAttributedString.Key.paragraphStyle: paragraph]).size()
                            ...
                            if dateFutureFontHighlight.lineHeight > dateTodayFontHighlight.lineHeight {
                                testStringSize = NSAttributedString(string: "00", attributes: [NSAttributedString.Key.font: dateFutureFontHighlight ?? UIFont.systemFontSize, NSAttributedString.Key.paragraphStyle: paragraph]).size()
                            ...
                            if datePastFontHighlight.lineHeight > dateFutureFontHighlight.lineHeight {
                                testStringSize = NSAttributedString(string: "00", attributes: [NSAttributedString.Key.font: datePastFontHighlight ?? UIFont.systemFontSize, NSAttributedString.Key.paragraphStyle: paragraph]).size()
                                dateMaxWidth = testStringSize.width
                                dateMaxHeight = testStringSize.height
                            }
...
internal class WWClock: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if time.hour < 12 {
            ...
            var str = NSAttributedString(string: "AM", attributes: [NSAttributedString.Key.font: fontAMPMHighlight ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: fontColorAMPMHighlight ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph])
            ...
            str = NSAttributedString(string: "PM", attributes: [NSAttributedString.Key.font: fontAMPM ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: fontColorAMPM ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph])
            ...
            var str = NSAttributedString(string: "AM", attributes: [NSAttributedString.Key.font: fontAMPM ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: fontColorAMPM ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph])
            var ampmHeight = fontAMPM.lineHeight
            str.draw(in: CGRect(x: amX, y: ampmY + (ampmSize - ampmHeight) / 2, width: ampmSize, height: ampmHeight))
            str = NSAttributedString(string: "PM", attributes: [NSAttributedString.Key.font: fontAMPMHighlight ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: fontColorAMPMHighlight ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph])
            ampmHeight = fontAMPMHighlight.lineHeight
            str.draw(in: CGRect(x: pmX, y: ampmY + (ampmSize - ampmHeight) / 2, width: ampmSize, height: ampmHeight))
        }
        
        if showingHour {
            let textAttr : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontHour ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: fontColorHour ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontHourHighlight ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: fontColorHourHighlight ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph]
            ...
            let textAttr : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontMinute ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: fontColorMinute ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontMinuteHighlight ?? UIFont.systemFontSize, NSAttributedString.Key.foregroundColor: fontColorMinuteHighlight ?? UIColor.black, NSAttributedString.Key.paragraphStyle: paragraph]
