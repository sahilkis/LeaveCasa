...
struct WSRequestParams {
    ...
    static let WS_REQS_PARAM_DATE_OF_BIRTH           = "DateOfBirth"
    ...
    static let WS_REQS_PARAM_FLIGHT_ITINERARY        = "FlightItinerary"
    static let WS_REQS_PARAM_GENDER                  = "gender"
    static let WS_REQS_PARAM_GROUP_CODE              = "group_code"
    static let WS_REQS_PARAM_GST_COMPANY_ADDRESS     = "GSTCompanyAddress"
    static let WS_REQS_PARAM_GST_COMPANY_CONTACT_NO  = "GSTCompanyContactNumber"
    static let WS_REQS_PARAM_GST_COMPANY_NAME        = "GSTCompanyName"
    static let WS_REQS_PARAM_GST_NUMBER              = "GSTNumber"
    static let WS_REQS_PARAM_GST_COMPANY_EMAIL       = "GSTCompanyEmail"
    ...
    static let WS_REQS_PARAM_IS_LEAD_PAX             = "IsLeadPax"
    ...
    static let WS_REQS_PARAM_PAX_TYPE                = "PaxType"
    static let WS_REQS_PARAM_PASSPORT_NO             = "PassportNo"
    static let WS_REQS_PARAM_PASSPORT_EXPIRY         = "PassportExpiry"
    ...
    static let WS_REQS_PARAM_SINGLE_LADIES           = "singleLadies"
...
struct WSResponseParams {
    ...
    static let WS_RESP_PARAM_BUS_BOOKING             = "bus_booking"
    ...
    static let WS_RESP_PARAM_HOTEL_BOOKING           = "hotel_booking"
